...
public:
    ...
    {
        MyForm->setWindowTitle(QCoreApplication::translate("MyForm", "L0 QT INI", nullptr));
        label->setText(QCoreApplication::translate("MyForm", "Centrar altura:", nullptr));
        label_2->setText(QCoreApplication::translate("MyForm", "Altura en metros:", nullptr));
